const cities=[
    ...
    "ARNAUD, Manitoba",
    "ARNES, Manitoba",
    "ARNOLDS COVE, Newfoundland and Labrador",
    "ARNPRIOR, Ontario",
    "ARNSTEIN, Ontario",
    "ARNTFIELD, Quebec",
    "AROLAND, Ontario",
    ...
    "BADGERS QUAY, Newfoundland and Labrador",
    "BADJEROS, Ontario",
    "BAGOT, Manitoba",
    "BAIE DE BOUCTOUCHE, New Brunswick",
    ...
    "BAIE-TRINITE, Quebec",
    "BAILIEBORO, Ontario",
    "BAILLIE, New Brunswick",
    "BAINE HARBOUR, Newfoundland and Labrador",
    "BAINS CORNER, New Brunswick",
    "BAINSVILLE, Ontario",
    "BAIRDSVILLE, New Brunswick",
    ...
    "BALMERTOWN, Ontario",
    "BALMORAL EST, New Brunswick",
    "BALMORAL SUD, New Brunswick",
    "BALMORAL, Manitoba",
    ...
    "BARNETTVILLE, New Brunswick",
    "BARNEYS RIVER STATION, Nova Scotia",
    "BARNWELL, Alberta",
    "BARONS, Alberta",
    "BARONY, New Brunswick",
    "BARR SETTLEMENT, Nova Scotia",
    "BARRA GLEN, Nova Scotia",
    ...
    "BEAVERBROOK ALBERT CO, New Brunswick",
    "BEAVERBROOK, New Brunswick",
    "BEAVERDELL, British Columbia",
    "BEAVERLODGE, Alberta",
    "BEAVERTON, Ontario",
    "BECANCOUR, Quebec",
    "BECKIM SETTLEMENT, New Brunswick",
    ...
    "BELFOUNTAIN, Ontario",
    "BELGRAVE, Ontario",
    "BELL ISLAND FRONT, Newfoundland and Labrador",
    ...
    "BIG COVE QUEENS CO, New Brunswick",
    "BIG HOLE, New Brunswick",
    "BIG LAKE RANCH, British Columbia",
    ...
    "BIRCHY HEAD, Newfoundland and Labrador",
    "BIRD COVE, Newfoundland and Labrador",
    "BIRDTON, New Brunswick",
    "BIRNIE, Manitoba",
    "BIRSAY, Saskatchewan",
    "BIRTLE, Manitoba",
    "BISCOTASING, Ontario",
    ...
    "BLACK DUCK SIDING, Newfoundland and Labrador",
    ...
    "BLACKFOOT, Alberta",
    "BLACKIE, Alberta",
    "BLACKLAND RESTIGOUCHE CO, New Brunswick",
    ...
    "BLOODVEIN, Manitoba",
    "BLOOMFIELD CARLETON CO, New Brunswick",
    "BLOOMFIELD KINGS CO, New Brunswick",
    ...
    "BLUE MOUNTAIN BEND, New Brunswick",
    ...
    "BLYTH, Ontario",
    "BLYTHESWOOD, Ontario",
    "BOAT HARBOUR WEST, Newfoundland and Labrador",
    "BOBCAYGEON, Ontario",
    ...
    "BOND HEAD, Ontario",
    "BONFIELD, Ontario",
    "BONNE BAY POND, Newfoundland and Labrador",
    ...
    "BOUCHERVILLE, Quebec",
    "BOUCHETTE, Quebec",
    "BOUCTOUCHE COVE, New Brunswick",
    "BOUCTOUCHE RESERVE, New Brunswick",
    "BOUCTOUCHE SUD, New Brunswick",
    "BOUCTOUCHE, New Brunswick",
    "BOUDREAU-OUEST, New Brunswick",
    "BOULANGER, Quebec",
    "BOULARDERIE CENTER, Nova Scotia",
    ...
    "BOWSMAN, Manitoba",
    "BOYDS COVE, Newfoundland and Labrador",
    "BOYLE, Alberta",
    ...
    "BRENTS COVE, Newfoundland and Labrador",
    "BRENTWOOD BAY, British Columbia",
    "BRENTWOOD, Nova Scotia",
    "BRESLAU, Ontario",
    "BRETON, Alberta",
    "BREWERS MILL, New Brunswick",
    "BREYNAT, Alberta",
    ...
    "BRIGDEN, Ontario",
    "BRIGGS CORNER QUEENS CO, New Brunswick",
    "BRIGHAM, Quebec",
    "BRIGHT SAND, Saskatchewan",
    "BRIGHT, Ontario",
    ...
    "BRISTOL JUNCTION, New Brunswick",
    "BRISTOL, Quebec",
    "BRITANNIA BEACH, British Columbia",
    "BRITISH SETTLEMENT, New Brunswick",
    "BRITT, Ontario",
    "BROAD COVE BDV, Newfoundland and Labrador",
    "BROAD VALLEY, Manitoba",
    ...
    "BROMONT, Quebec",
    "BRONSON SETTLEMENT, New Brunswick",
    "BROOKDALE, Manitoba",
    ...
    "BRUNNER, Ontario",
    "BRUNO, Saskatchewan",
    "BRUNSWICK MINES, New Brunswick",
    "BRUSSELS, Ontario",
    "BRUXELLES, Manitoba",
    "BRYENTON, New Brunswick",
    "BRYSON, Quebec",
    "BUBARTOWN, New Brunswick",
    ...
    "BUFFALO CREEK, British Columbia",
    ...
    "BULYEA, Saskatchewan",
    "BUNYANS COVE, Newfoundland and Labrador",
    "BURDETT, Alberta",
    "BURFORD, Ontario",
    "BURGEO, Newfoundland and Labrador",
    "BURGESSVILLE, Ontario",
    "BURGOYNES COVE, Newfoundland and Labrador",
    ...
    "BURNT ISLANDS BLP, Newfoundland and Labrador",
    "BURNT POINT BDV, Newfoundland and Labrador",
    "BURNT RIVER, Ontario",
    "BURNTLAND BROOK, New Brunswick",
    ...
    "CALIFORNIA SETTLEMENT, New Brunswick",
    "CALIXA-LAVALLEE, Quebec",
    "CALLANDER, Ontario",
    ...
    "CAMPBELL SETTLEMENT YORK CO, New Brunswick",
    ...
    "CAPE STATION, New Brunswick",
    "CAPE TORMENTINE, New Brunswick",
    "CAPLAN, Quebec",
    "CAPLIN COVE BDV, Newfoundland and Labrador",
    ...
    "CARSELAND, Alberta",
    "CARSONVILLE, New Brunswick",
    "CARSTAIRS, Alberta",
    "CARTERS COVE, Newfoundland and Labrador",
    ...
    "CASTLETON, Ontario",
    "CASTOR, Alberta",
    "CASTORS RIVER, Newfoundland and Labrador",
    "CAT LAKE, Ontario",
    ...
    "CENTRAL GREENWICH, New Brunswick",
    "CENTRAL HAINESVILLE, New Brunswick",
    "CENTRAL HAMPSTEAD, New Brunswick",
    ...
    "CEYLON, Saskatchewan",
    "CHALK RIVER, Ontario",
    "CHAMBERLAIN SETTLEMENT, New Brunswick",
    "CHAMBERLAIN, Saskatchewan",
    "CHAMBERS SETTLEMENT, New Brunswick",
    "CHAMBLY, Quebec",
    "CHAMBORD, Quebec",
    ...
    "CHAPEL COVE, Newfoundland and Labrador",
    "CHAPLEAU, Ontario",
    "CHAPLIN ISLAND ROAD, New Brunswick",
    ...
    "CHARLEMAGNE, Quebec",
    "CHARLESTON, New Brunswick",
    "CHARLESTON, Newfoundland and Labrador",
    "CHARLIE LAKE, British Columbia",
    "CHARLIE LAKE, New Brunswick",
    "CHARLO SOUTH, New Brunswick",
    ...
    "CLARESHOLM, Alberta",
    "CLARKE CITY, Quebec",
    "CLARKES BEACH, Newfoundland and Labrador",
    "CLARKS CORNER, New Brunswick",
    ...
    "CLOUTIER, Quebec",
    "CLOVA, Quebec",
    "CLOVER HILL, New Brunswick",
    "CLOVER VALLEY, New Brunswick",
    ...
    "CLYDE RIVER, Nunavut",
    "CLYDE, Alberta",
    "COACHMANS COVE, Newfoundland and Labrador",
    "COAL BRANCH, New Brunswick",
    "COAL CREEK, New Brunswick",
    "COAL HARBOUR, British Columbia",
    "COALDALE, Alberta",
    "COALHURST, Alberta",
    "COALMONT, British Columbia",
    "COATICOOK, Quebec",
    "COATSWORTH STATION, Ontario",
    "COBALT, Ontario",
    ...
    "COLES ISLAND QUEENS CO, New Brunswick",
    "COLEVILLE, Saskatchewan",
    "COLEYS POINT SOUTH, Newfoundland and Labrador",
    "COLFAX, Saskatchewan",
    ...
    "COLLIERS RIVERHEAD, Newfoundland and Labrador",
    ...
    "COOKS HARBOUR, Newfoundland and Labrador",
    "COOKSHIRE-EATON, Quebec",
    "COOKSTOWN, Ontario",
    "COOKVILLE, New Brunswick",
    "COOKVILLE, Nova Scotia",
    "COOMBS, British Columbia",
    "COPETOWN, Ontario",
    "COPPER CLIFF, Ontario",
    "COPPERSANDS, Saskatchewan",
    ...
    "COTTRELLS COVE, Newfoundland and Labrador",
    "COULTER, Manitoba",
    ...
    "COXS COVE, Newfoundland and Labrador",
    "CRABTREE, Quebec",
    "CRAIG FLATS, New Brunswick",
    "CRAIGMORE, Nova Scotia",
    "CRAIGMYLE, Alberta",
    "CRAIK, Saskatchewan",
    "CRANBERRY PORTAGE, Manitoba",
    "CRANBROOK, British Columbia",
    "CRANDALL ROAD, Nova Scotia",
    "CRANDALL, Manitoba",
    ...
    "CRESTON, Newfoundland and Labrador",
    "CROCKER HILL, New Brunswick",
    ...
    "CROSSFIELD, Alberta",
    "CROTON, Ontario",
    "CROUSES SETTLEMENT, Nova Scotia",
    ...
    "CURRAN, Ontario",
    "CURRIE SIDING, New Brunswick",
    "CURRIEBURG, New Brunswick",
    "CURRYS CORNER, Nova Scotia",
    "CURRYVILLE, New Brunswick",
    "CURVE LAKE, Ontario",
    "CURVENTON, New Brunswick",
    ...
    "DANFORD LAKE, Quebec",
    "DANIELS HARBOUR, Newfoundland and Labrador",
    "DANVILLE, Quebec",
    "DAPP, Alberta",
    ...
    "DAWSON, Yukon",
    "DAWSONS LANDING, British Columbia",
    ...
    "DENSMORES MILLS, Nova Scotia",
    "DENWOOD, Alberta",
    "DENZIL, Saskatchewan",
    "DERBY JUNCTION, New Brunswick",
    "DERBY, New Brunswick",
    ...
    "DISRAELI, Quebec",
    "DIVIDE, New Brunswick",
    "DIXONVILLE, Alberta",
    "DIXVILLE, Quebec",
    "DOAKTOWN, New Brunswick",
    "DOBBINTON, Ontario",
    "DOBIE, Ontario",
    "DOBSON CORNER, New Brunswick",
    ...
    "DORION, Ontario",
    "DOROTHY, Alberta",
    "DORRINGTON HILL, New Brunswick",
    "DORSET, Ontario",
    "DORVAL, Quebec",
    "DOSQUET, Quebec",
    "DOUGLAS HARBOUR, New Brunswick",
    ...
    "DRURYS COVE, New Brunswick",
    "DRYDEN, Ontario",
    "DSL DE DRUMMOND, New Brunswick",
    "DSL DE GRAND-SAULT/FALLS, New Brunswick",
    "DUART, Ontario",
    "DUBEE SETTLEMENT, New Brunswick",
    "DUBLIN, Ontario",
    ...
    "DUCLOS, Quebec",
    "DUFF, Saskatchewan",
    "DUFFERIN CHARLOTTE CO, New Brunswick",
    "DUFFERIN QUEENS CO, New Brunswick",
    "DUFFIELD, Alberta",
    "DUFRESNE, Manitoba",
    "DUFROST, Manitoba",
    "DUGALD, Manitoba",
    ...
    "EAST BRIGHTON, New Brunswick",
    "EAST BROUGHTON STATION, Quebec",
    "EAST BROUGHTON, Quebec",
    "EAST CENTREVILLE, New Brunswick",
    "EAST CLIFFORD, Nova Scotia",
    "EAST COLDSTREAM, New Brunswick",
    "EAST COULEE, Alberta",
    ...
    "EDDIES COVE, Newfoundland and Labrador",
    "EDDYSTONE, Manitoba",
    "EDEN MILLS, Ontario",
    "EDEN, Manitoba",
    "EDEN, Ontario",
    ...
    "EVANS ROAD, New Brunswick",
    "EVANSBURG, Alberta",
    "EVANSVILLE, Ontario",
    "EVERETT, New Brunswick",
    "EVERETT, Ontario",
    "EVESHAM, Saskatchewan",
    "EXETER, Ontario",
    "EXMOOR, New Brunswick",
    "EXSHAW, Alberta",
    ...
    "FAIRFAX, Manitoba",
    "FAIRFIELD WESTMORLAND CO, New Brunswick",
    ...
    "FISHERMANS HARBOUR, Nova Scotia",
    "FISHERVILLE, Ontario",
    "FISKE, Saskatchewan",
    "FITZGERALD, Alberta",
    ...
    "FOUR CORNERS, New Brunswick",
    "FOUR FALLS, New Brunswick",
    "FOUR ROADS, New Brunswick",
    "FOURCHU, Nova Scotia",
    "FOURNIER, Ontario",
    "FOX CREEK, Alberta",
    "FOX HARBOUR PB, Newfoundland and Labrador",
    "FOX LAKE, Alberta",
    ...
    "FOXWARREN, Manitoba",
    "FOYMOUNT, Ontario",
    "FRAMBOISE INTERVALE, Nova Scotia",
    ...
    "FREDERICKSBURG, New Brunswick",
    "FREDERICKTON, Newfoundland and Labrador",
    "FREDERICTON JUNCTION, New Brunswick",
    "FREDERICTON, New Brunswick",
    "FREE GRANT, New Brunswick",
    "FREELTON, Ontario",
    "FREEPORT, Nova Scotia",
    "FREETOWN, Prince Edward Island",
    "FRELIGHSBURG, Quebec",
    "FRENCH LAKE, New Brunswick",
    "FRENCH ROAD, Nova Scotia",
    "FRENCH VILLAGE KINGS CO, New Brunswick",
    "FRENCH VILLAGE, Nova Scotia",
    "FRENCH VILLAGE-YORK, New Brunswick",
    "FRENCHMAN BUTTE, Saskatchewan",
    "FRENCHMANS COVE BOI, Newfoundland and Labrador",
    "FRENCHMANS COVE FB, Newfoundland and Labrador",
    "FRENCHVALE, Nova Scotia",
    "FRESHWATER PB, Newfoundland and Labrador",
    "FROBISHER, Saskatchewan",
    "FROG LAKE, Alberta",
    "FRONTENAC, Quebec",
    "FRONTIER, Saskatchewan",
    "FROSTY HOLLOW, New Brunswick",
    ...
    "GALLIX, Quebec",
    "GALLOWAY, British Columbia",
    "GALLOWAY, New Brunswick",
    "GAMBO SOUTH, Newfoundland and Labrador",
    ...
    "GERMANTOWN, New Brunswick",
    "GETHSEMANI, Quebec",
    "GIANTS GLEN, New Brunswick",
    "GIBBONS, Alberta",
    ...
    "GLOUCESTER JUNCTION, New Brunswick",
    "GLOUCESTER, Ontario",
    "GLOVERTOWN SOUTH, Newfoundland and Labrador",
    ...
    "GRAND BAY EAST, Newfoundland and Labrador",
    ...
    "GREEN RIDGE, Manitoba",
    "GREEN ROAD, New Brunswick",
    ...
    "GREENWOOD, Ontario",
    "GREGG SETTLEMENT, New Brunswick",
    ...
    "HANNON, Ontario",
    "HANOVER, Ontario",
    "HANTS HARBOUR, Newfoundland and Labrador",
    ...
    "HARE BAY BB, Newfoundland and Labrador",
    ...
    "HARRISTON, Ontario",
    "HARROGATE, British Columbia",
    "HARROW, Ontario",
    "HARROWSMITH, Ontario",
    "HARRYS HARBOUR, Newfoundland and Labrador",
    ...
    "HARTLEY SETTLEMENT, New Brunswick",
    "HARTNEY, Manitoba",
    "HARTY, Ontario",
    "HARVEY ALBERT CO, New Brunswick",
    ...
    "HATLEY, Quebec",
    "HAUT-LAMEQUE, New Brunswick",
    "HAUT-PAQUETVILLE, New Brunswick",
    "HAUT-RIVIERE-DU-PORTAGE, New Brunswick",
    "HAUT-SAINT-ANTOINE, New Brunswick",
    ...
    "HAWKESTONE, Ontario",
    "HAWKESVILLE, Ontario",
    "HAWKINS CORNER, New Brunswick",
    "HAWKSHAW, New Brunswick",
    "HAY LAKES, Alberta",
    "HAY RIVER, Northwest Territories",
    "HAY SETTLEMENT, New Brunswick",
    "HAY, Ontario",
    "HAYDON, Ontario",
    "HAYESVILLE, New Brunswick",
    "HAYMAN HILL, New Brunswick",
    "HAYS, Alberta",
    "HAYTER, Alberta",
    "HAYWOOD, Manitoba",
    ...
    "HAZELTON, New Brunswick",
    "HAZENMORE, Saskatchewan",
    "HAZLET, Saskatchewan",
    "HEAD BAY D'ESPOIR, Newfoundland and Labrador",
    ...
    "HERSONVILLE, New Brunswick",
    "HEWARD, Saskatchewan",
    "HIBERNIA COVE, New Brunswick",
    "HICKMANS HARBOUR, Newfoundland and Labrador",
    "HICKSON, Ontario",
    "HICKSVILLE, New Brunswick",
    "HIGH BLUFF, Manitoba",
    "HIGH LEVEL, Alberta",
    "HIGH PRAIRIE, Alberta",
    "HIGH RIVER, Alberta",
    "HIGHFIELD, New Brunswick",
    "HIGHGATE, Ontario",
    "HIGHLAND GROVE, Ontario",
    "HIGHLAND HILL, Nova Scotia",
    "HIGHLANDS, Newfoundland and Labrador",
    "HILBRE, Manitoba",
    "HILDA, Alberta",
    "HILL SPRING, Alberta",
    "HILLANDALE, New Brunswick",
    "HILLCREST MINES, Alberta",
    "HILLGRADE, Newfoundland and Labrador",
    "HILLGROVE, New Brunswick",
    "HILLIARD, Alberta",
    "HILLIARDTON, Ontario",
    "HILLIER, Ontario",
    "HILLSBOROUGH WEST, New Brunswick",
    "HILLSBOROUGH, New Brunswick",
    "HILLSBURGH, Ontario",
    "HILLSDALE, New Brunswick",
    "HILLSDALE, Ontario",
    "HILLSIDE BOULARDERIE, Nova Scotia",
    "HILLTOP, New Brunswick",
    ...
    "HOBBEMA, Alberta",
    "HODGES COVE, Newfoundland and Labrador",
    ...
    "HOWARD BROOK, New Brunswick",
    "HOWARD, New Brunswick",
    "HOWDEN, Manitoba",
    "HOWICK, Quebec",
    "HOWIE CENTER, Nova Scotia",
    ...
    "ILE-AUX-NOIX, Quebec",
    "ILFORD, Manitoba",
    "IMMIGRANT ROAD, New Brunswick",
    "IMPERIAL, Saskatchewan",
    "INDIAN BAY BB, Newfoundland and Labrador",
    ...
    "IRISH SETTLEMENT, New Brunswick",
    "IRISHTOWN, New Brunswick",
    "IRISHVALE, Nova Scotia",
    "IRLANDE, Quebec",
    "IRMA, Alberta",
    "IRON BOUND COVE, New Brunswick",
    "IRON BRIDGE, Ontario",
    "IRON RIVER, Alberta",
    ...
    "JACKSON FALLS, New Brunswick",
    "JACKSONS ARM, Newfoundland and Labrador",
    "JACKSONS COVE, Newfoundland and Labrador",
    ...
    "JEDDORE OYSTER PONDS, Nova Scotia",
    "JEFFREYS, Newfoundland and Labrador",
    "JEFFRIES CORNER, New Brunswick",
    "JELLICOE, Ontario",
    "JEMSEG, New Brunswick",
    "JENNER, Alberta",
    "JERSEYSIDE, Newfoundland and Labrador",
    "JERSEYVILLE, Ontario",
    "JEWETTS MILLS, New Brunswick",
    "JOBS COVE, Newfoundland and Labrador",
    "JOE BATTS ARM, Newfoundland and Labrador",
    "JOGGINS, Nova Scotia",
    "JOGUES, Ontario",
    "JOHN D'OR PRAIRIE, Alberta",
    "JOHNSON SETTLEMENT CHARLOTTE C, New Brunswick",
    "JOHNSON SETTLEMENT YORK CO, New Brunswick",
    "JOHNSON'S MILLS, New Brunswick",
    "JOHNSTON POINT, New Brunswick",
    ...
    "KEARNEY, Ontario",
    "KEARNS, Ontario",
    "KEDGWICK NORD, New Brunswick",
    "KEDGWICK OUEST, New Brunswick",
    "KEDGWICK RIVER, New Brunswick",
    "KEDGWICK SUD, New Brunswick",
    "KEDGWICK, New Brunswick",
    "KEELER, Saskatchewan",
    "KEELS, Newfoundland and Labrador",
    "KEENANS, New Brunswick",
    "KEENE, Ontario",
    "KEEWATIN, Ontario",
    "KEEWAYWIN, Ontario",
    "KEG RIVER, Alberta",
    ...
    "KIAMIKA, Quebec",
    "KIERSTEAD MOUNTAIN, New Brunswick",
    ...
    "KILLAM, Alberta",
    "KILLAMS MILLS, New Brunswick",
    "KILLARNEY ROAD, New Brunswick",
    "KILLARNEY, Manitoba",
    "KILLARNEY, Ontario",
    "KILLOWEEN, New Brunswick",
    "KILWORTHY, Ontario",
    ...
    "KINGMAN, Alberta",
    "KINGS COVE, Newfoundland and Labrador",
    "KINGS LANDING HISTORICAL SETTL, New Brunswick",
    "KINGS POINT, Newfoundland and Labrador",
    "KINGSBURY, Quebec",
    ...
    "KINLEY, Saskatchewan",
    "KINMOUNT, Ontario",
    "KINNEAR SETTLEMENT, New Brunswick",
    ...
    "L'ASCENSION-DE-PATAPEDIA, Quebec",
    "L'ASSOMPTION, Quebec",
    "L'AVENIR, Quebec",
    "L'EPIPHANIE, Quebec",
    "L'ETANG-DU-NORD, Quebec",
    ...
    "LA TABATIERE, Quebec",
    "LA TRINITE-DES-MONTS, Quebec",
    "LA TUQUE, Quebec",
    "LA VISITATION-DE-L'ILE-DUPAS, Quebec",
    ...
    "LAKEVILLE CARLETON CO, New Brunswick",
    "LAKEVILLE CORNER, New Brunswick",
    "LAKEVILLE-WESTMORLAND, New Brunswick",
    "LAMALINE, Newfoundland and Labrador",
    "LAMARCHE, Quebec",
    "LAMARTINE, Quebec",
    "LAMBERT'S COVE, New Brunswick",
    ...
    "LINDEN, Alberta",
    "LINDSAY, New Brunswick",
    "LINDSAY, Ontario",
    "LINGAN ROAD, Nova Scotia",
    "LINGAN, Nova Scotia",
    "LINGWICK, Quebec",
    "LINTLAW, Saskatchewan",
    "LINTON CORNER, New Brunswick",
    "LINWOOD, Ontario",
    ...
    "LISTOWEL, Ontario",
    "LISTUGUJ, Quebec",
    "LITTLE BARTIBOG, New Brunswick",
    "LITTLE BAY EAST, Newfoundland and Labrador",
    "LITTLE BAY ISLANDS, Newfoundland and Labrador",
    "LITTLE BAY NDB, Newfoundland and Labrador",
    "LITTLE BAY PB, Newfoundland and Labrador",
    ...
    "LITTLE HARBOUR EAST PB, Newfoundland and Labrador",
    "LITTLE HEARTS EASE, Newfoundland and Labrador",
    ...
    "LITTLE RIVER ALBERT CO, New Brunswick",
    "LITTLE RIVER GLOUCESTER CO, New Brunswick",
    "LITTLE RIVER HILL, New Brunswick",
    "LITTLE RIVER, Nova Scotia",
    "LITTLE SALMON RIVER WEST, New Brunswick",
    "LITTLE SHEMOGUE, New Brunswick",
    "LITTLE SMOKY, Alberta",
    "LITTLE ST LAWRENCE, Newfoundland and Labrador",
    "LITTLE TANCOOK, Nova Scotia",
    ...
    "LONG SAULT, Ontario",
    "LONG SETTLEMENT KINGS CO, New Brunswick",
    "LONG SETTLEMENT, New Brunswick",
    ...
    "LOWER CAMBRIDGE, New Brunswick",
    "LOWER CAPE, New Brunswick",
    "LOWER COVE, New Brunswick",
    "LOWER COVERDALE, New Brunswick",
    "LOWER DERBY, New Brunswick",
    "LOWER EAST PUBNICO, Nova Scotia",
    "LOWER FIVE ISLANDS, Nova Scotia",
    "LOWER GREENWICH, New Brunswick",
    "LOWER HAINESVILLE, New Brunswick",
    ...
    "MACGREGOR, Manitoba",
    "MACKAY SIDING, Nova Scotia",
    "MACKDALE, Nova Scotia",
    "MACKENZIE, British Columbia",
    "MACKEY, Ontario",
    "MACKINNONS HARBOUR, Nova Scotia",
    "MACKLIN, Saskatchewan",
    "MACLAGGAN BRIDGE, New Brunswick",
    ...
    "MACTIER, Ontario",
    "MADAWASKA MALISEET FRST NATION, New Brunswick",
    "MADAWASKA, Ontario",
    "MADDEN, Alberta",
    "MADDINGTON, Quebec",
    ...
    "MANN'S MOUNTAIN, New Brunswick",
    "MANNHURST, New Brunswick",
    ...
    "MAPLE GLEN, New Brunswick",
    "MAPLE GROVE, New Brunswick",
    "MAPLE GROVE, Nova Scotia",
    "MAPLE GROVE, Quebec",
    "MAPLE LEAF, Ontario",
    "MAPLE RIDGE, British Columbia",
    "MAPLE RIDGE, New Brunswick",
    "MAPLE VIEW, New Brunswick",
    "MAPLE, Ontario",
    "MAPLEDALE, New Brunswick",
    ...
    "MARYHILL, Ontario",
    "MARYS HARBOUR, Newfoundland and Labrador",
    ...
    "MATANE, Quebec",
    "MATAPEDIA, Quebec",
    "MATES CORNER, New Brunswick",
    "MATHER, Manitoba",
    "MATHESON ISLAND, Manitoba",
    "MATHESON, Ontario",
    "MATLOCK, Manitoba",
    "MATTAWA, Ontario",
    "MATTHEWS SETTLEMENT, New Brunswick",
    "MATTICE, Ontario",
    "MAUGERVILLE, New Brunswick",
    "MAVILLETTE, Nova Scotia",
    "MAXVILLE, Ontario",
    "MAXWELL, New Brunswick",
    "MAXWELL, Ontario",
    "MAYERTHORPE, Alberta",
    ...
    "MICMAC, Nova Scotia",
    "MIDALE, Saskatchewan",
    "MIDDLE ARM GB, Newfoundland and Labrador",
    "MIDDLE BAY, Quebec",
    "MIDDLE CAPE, Nova Scotia",
    "MIDDLE COVE, Newfoundland and Labrador",
    "MIDDLE HAINESVILLE, New Brunswick",
    ...
    "MIDHURST, Ontario",
    "MIDLAND KINGS CO, New Brunswick",
    "MIDLAND QUEENS CO, New Brunswick",
    "MIDLAND, Ontario",
    "MIDVILLE BRANCH, Nova Scotia",
    "MIDWAY, British Columbia",
    "MIDWAY, New Brunswick",
    "MIGISI SAHGAIGAN, Ontario",
    "MIKADO, Saskatchewan",
    "MILAN, Quebec",
    "MILDEN, Saskatchewan",
    "MILDMAY, Ontario",
    "MILDRED, Saskatchewan",
    ...
    "MILL BROOK, New Brunswick",
    "MILL COVE, New Brunswick",
    ...
    "MINGS BIGHT, Newfoundland and Labrador",
    "MINIOTA, Manitoba",
    ...
    "MOFFAT, Ontario",
    "MOFFET, Quebec",
    "MOHANNES, New Brunswick",
    "MOISIE, Quebec",
    "MOLEGA LAKE, Nova Scotia",
    "MONARCH, Alberta",
    ...
    "MORETONS HARBOUR, Newfoundland and Labrador",
    "MOREWOOD, Ontario",
    ...
    "NEW BANDON GLOUCESTER CO, New Brunswick",
    "NEW BANDON NORTHUMB CO, New Brunswick",
    ...
    "NEW CARLISLE, Quebec",
    "NEW CHELSEA, Newfoundland and Labrador",
    "NEW DAYTON, Alberta",
    ...
    "NEW HAMBURG, Ontario",
    "NEW HARBOUR TB, Newfoundland and Labrador",
    "NEW HARRIS, Nova Scotia",
    "NEW HAVEN, Nova Scotia",
    "NEW HAZELTON, British Columbia",
    "NEW HORTON, New Brunswick",
    "NEW JERSEY, New Brunswick",
    "NEW LINE, New Brunswick",
    "NEW LISKEARD, Ontario",
    "NEW LOWELL, Ontario",
    "NEW MARKET, New Brunswick",
    "NEW MARYLAND, New Brunswick",
    "NEW MELBOURNE, Newfoundland and Labrador",
    ...
    "NEW SONGHEES 1A, British Columbia",
    "NEW VICTORIA, Nova Scotia",
    "NEW WATERFORD, Nova Scotia",
    "NEW WESTMINSTER, British Columbia",
    "NEW ZION, New Brunswick",
    "NEWBORO, Ontario",
    "NEWBRIDGE, New Brunswick",
    "NEWBROOK, Alberta",
    "NEWBURG, New Brunswick",
    "NEWBURGH, Ontario",
    "NEWBURY, Ontario",
    ...
    "NEWDALE, Manitoba",
    "NEWINGTON, Ontario",
    "NEWMANS COVE, Newfoundland and Labrador",
    "NEWMARKET, Ontario",
    "NEWPORT STATION, Nova Scotia",
    "NEWPORT, Nova Scotia",
    "NEWPORT, Quebec",
    "NEWTON SIDING, Manitoba",
    "NEWTON, Ontario",
    "NEWTONVILLE, Ontario",
    "NEWTOWN, New Brunswick",
    ...
    "NOBLETON, Ontario",
    "NOEL, Nova Scotia",
    "NOELS POND, Newfoundland and Labrador",
    "NOELVILLE, Ontario",
    ...
    "NORMANDIN, Quebec",
    "NORMANS COVE, Newfoundland and Labrador",
    "NORMETAL, Quebec",
    "NORQUAY, Saskatchewan",
    "NORRIS ARM NORTHSIDE, Newfoundland and Labrador",
    ...
    "NORTH GOWER, Ontario",
    "NORTH HARBOUR PB, Newfoundland and Labrador",
    "NORTH HARBOUR SMB, Newfoundland and Labrador",
    "NORTH HATLEY, Quebec",
    ...
    "NORTH SALEM, Nova Scotia",
    "NORTH SHANNONVALE, New Brunswick",
    "NORTH SPIRIT LAKE, Ontario",
    "NORTH STAR, Alberta",
    "NORTH SYDNEY, Nova Scotia",
    "NORTH TAY, New Brunswick",
    "NORTH TETAGOUCHE, New Brunswick",
    "NORTH VALLEY, Newfoundland and Labrador",
    "NORTH VANCOUVER, British Columbia",
    "NORTH VIEW, New Brunswick",
    ...
    "NOTRE-DAME-DES-ERABLES, New Brunswick",
    ...
    "OAK BLUFF, Manitoba",
    "OAK HAVEN, New Brunswick",
    "OAK HILL, New Brunswick",
    "OAK LAKE, Manitoba",
    "OAK MOUNTAIN, New Brunswick",
    "OAK POINT KINGS CO, New Brunswick",
    "OAK POINT, Manitoba",
    ...
    "OAKHILL, Nova Scotia",
    "OAKLAND, New Brunswick",
    "OAKLAND, Ontario",
    "OAKVIEW, Manitoba",
    "OAKVILLE, Manitoba",
    "OAKVILLE, New Brunswick",
    "OAKVILLE, Ontario",
    "OAKWOOD, Ontario",
    "OBA, Ontario",
    "OBEDJIWAN, Quebec",
    ...
    "PARLEE BROOK, New Brunswick",
    "PARLEEVILLE, New Brunswick",
    "PARRSBORO, Nova Scotia",
    "PARRY SOUND, Ontario",
    "PARRY, Saskatchewan",
    "PARSON, British Columbia",
    "PARSONS POND, Newfoundland and Labrador",
    ...
    "PIKWITONEI, Manitoba",
    "PILGER, Saskatchewan",
    "PILLEYS ISLAND, Newfoundland and Labrador",
    ...
    "PLEASANT HILL, Nova Scotia",
    "PLEASANT RIDGE CHAR COUNTY, New Brunswick",
    "PLEASANT RIDGE KINGS CO, New Brunswick",
    "PLEASANT VILLA, New Brunswick",
    ...
    "POINTE A TOM, New Brunswick",
    "POINTE AUX ROCHES, Ontario",
    "POINTE DES ROBICHAUD, New Brunswick",
    "POINTE DIXON POINT, New Brunswick",
    ...
    "POOLE, Ontario",
    "POOLS COVE, Newfoundland and Labrador",
    "POOLS ISLAND, Newfoundland and Labrador",
    "POPLAR HILL, Ontario",
    ...
    "PORT ALMA, Ontario",
    "PORT ANSON, Newfoundland and Labrador",
    ...
    "PORTAGE ST-LOUIS, New Brunswick",
    "PORTAGE VALE, New Brunswick",
    ...
    "PRINCESS PARK, New Brunswick",
    "PRINCETON, British Columbia",
    "PRINCETON, Newfoundland and Labrador",
    "PRINCETON, Ontario",
    "PRINCEVILLE, Quebec",
    "PRINTZ COVE, New Brunswick",
    ...
    "PUTNAM, Ontario",
    "PUVIRNITUQ, Quebec",
    "PYNN'S BROOK, Newfoundland and Labrador",
    "QIKIQTARJUAQ, Nunavut",
    "QU'APPELLE, Saskatchewan",
    "QUADEVILLE, Ontario",
    "QUAKER BROOK, New Brunswick",
    ...
    "REABORO, Ontario",
    "RED BANK QUEENS CO, New Brunswick",
    "RED BANK RESERVE, New Brunswick",
    "RED BANK, New Brunswick",
    "RED BAY, Newfoundland and Labrador",
    "RED BRIDGE, New Brunswick",
    "RED DEER COUNTY, Alberta",
    "RED DEER, Alberta",
    "RED EARTH CREEK, Alberta",
    "RED EARTH, Saskatchewan",
    "RED HARBOUR PB, Newfoundland and Labrador",
    "RED HEAD COVE, Newfoundland and Labrador",
    "RED LAKE, Ontario",
    "RED POINT, Nova Scotia",
    "RED RAPIDS, New Brunswick",
    "RED ROCK, New Brunswick",
    "RED ROCK, Ontario",
    ...
    "RICHMOND SETTLEMENT, New Brunswick",
    ...
    "RIMBEY, Alberta",
    "RIMOUSKI, Quebec",
    "RINES CREEK, Nova Scotia",
    "RIO GRANDE, New Brunswick",
    ...
    "RIVERBANK CARLETON CO, New Brunswick",
    "RIVERBANK KINGS CO, New Brunswick",
    "RIVERBANK SOUTH, New Brunswick",
    "RIVERCOURSE, Alberta",
    "RIVERHEAD HARBOUR GRACE, Newfoundland and Labrador",
    "RIVERHURST, Saskatchewan",
    "RIVERPORT, Nova Scotia",
    "RIVERS, Manitoba",
    "RIVERSDALE, Nova Scotia",
    "RIVERSIDE ESTATES, Saskatchewan",
    "RIVERSIDE, Nova Scotia",
    "RIVERSIDE-ALBERT, New Brunswick",
    "RIVERTON, Manitoba",
    "RIVERVIEW, New Brunswick",
    "RIVIERE A LA TRUITE, New Brunswick",
    "RIVIERE DU NORD, New Brunswick",
    "RIVIERE QUI BARRE, Alberta",
    "RIVIERE-A-CLAUDE, Quebec",
    ...
    "RIVIERE-HEVA, Quebec",
    "RIVIERE-MADELEINE, Quebec",
    "RIVIERE-OUELLE, Quebec",
    "RIVIERE-PASPEBIAC, Quebec",
    "RIVIERE-PENTECOTE, Quebec",
    "RIVIERE-ROUGE, Quebec",
    "RIVIERE-SAINT-JEAN, Quebec",
    "RIVIERE-SAINT-PAUL, Quebec",
    "RIVIERE-TROIS-PISTOLES, Quebec",
    "RIVIERE-VERTE, New Brunswick",
    "ROACHVILLE, New Brunswick",
    "ROBB, Alberta",
    "ROBERTS ARM, Newfoundland and Labrador",
    "ROBERTS CREEK, British Columbia",
    "ROBERTVILLE, New Brunswick",
    "ROBERVAL, Quebec",
    "ROBICHAUD SETTLEMENT, New Brunswick",
    ...
    "ROGERSVILLE-EST, New Brunswick",
    "ROGERSVILLE-OUEST, New Brunswick",
    "ROKEBY, Saskatchewan",
    "ROLAND, Manitoba",
    ...
    "ROSEDALE VALLEY, Alberta",
    "ROSEDALE, British Columbia",
    "ROSEDALE, New Brunswick",
    "ROSEHILL, New Brunswick",
    "ROSEISLE, Manitoba",
    "ROSEMARY, Alberta",
    "ROSEMERE, Quebec",
    "ROSEMONT, Ontario",
    ...
    "ROUND HARBOUR GB, Newfoundland and Labrador",
    "ROUND HILL, Alberta",
    ...
    "ROWLEY, Alberta",
    "ROWLEY, New Brunswick",
    "ROXBORO, Quebec",
    "ROXTON FALLS, Quebec",
    "ROXTON POND, Quebec",
    "ROYAL ROAD, New Brunswick",
    "ROYALTON, New Brunswick",
    "ROYSTON, British Columbia",
    "RUDDELL, Saskatchewan",
    "RUISSEAU-A-REBOURS, Quebec",
    "RUMSEY, Alberta",
    ...
    "SAINT-ANACLET, Quebec",
    "SAINT-ANDRE, New Brunswick",
    "SAINT-ANDRE-AVELLIN, Quebec",
    "SAINT-ANDRE-D'ARGENTEUIL, Quebec",
    "SAINT-ANDRE-DE-KAMOURASKA, Quebec",
    "SAINT-ANDRE-DE-RESTIGOUCHE, Quebec",
    "SAINT-ANDRE-DU-LAC-SAINT-JEAN, Quebec",
    "SAINT-ANDRE-LEBLANC, New Brunswick",
    "SAINT-ANICET, Quebec",
    "SAINT-ANSELME, Quebec",
    "SAINT-ANTOINE SUD, New Brunswick",
    "SAINT-ANTOINE, New Brunswick",
    "SAINT-ANTOINE-ABBE, Quebec",
    "SAINT-ANTOINE-DE-KENT, New Brunswick",
    ...
    "SAINT-AUGUSTIN-SAGUENAY, Quebec",
    ...
    "SAINT-BRUNO-LAC-SAINT-JEAN, Quebec",
    "SAINT-CALIXTE, Quebec",
    "SAINT-CAMILLE, Quebec",
    "SAINT-CAMILLE-DE-BELLECHASSE, Quebec",
    ...
    "SAINT-CLAUDE, Quebec",
    "SAINT-CLEMENT, Quebec",
    "SAINT-CLEOPHAS, Quebec",
    "SAINT-CLEOPHAS-DE-BRANDON, Quebec",
    "SAINT-CLET, Quebec",
    ...
    "SAINT-CYPRIEN-DES-ETCHEMINS, Quebec",
    "SAINT-CYRILLE-DE-L'ISLET, Quebec",
    "SAINT-CYRILLE-DE-WENDOVER, Quebec",
    "SAINT-DAMASE, Quebec",
    "SAINT-DAMASE-DE-MATAPEDIA, Quebec",
    "SAINT-DAMASE-DES-AULNAIES, Quebec",
    "SAINT-DAMIEN, New Brunswick",
    "SAINT-DAMIEN, Quebec",
    ...
    "SAINT-EDOUARD-DE-LOTBINIERE, Quebec",
    "SAINT-EDOUARD-DE-MASKINONGE, Quebec",
    "SAINT-EDOUARD-DE-NAPIERVILLE, Quebec",
    "SAINT-ELIE-DE-CAXTON, Quebec",
    "SAINT-ELOI, Quebec",
    "SAINT-ELPHEGE, Quebec",
    "SAINT-ELZEAR, Quebec",
    "SAINT-ELZEAR-DE-BONAVENTURE, Quebec",
    "SAINT-ELZEAR-DE-TEMISCOUATA, Quebec",
    "SAINT-EMILE-DE-SUFFOLK, Quebec",
    "SAINT-EPHREM-DE-BEAUCE, Quebec",
    "SAINT-EPIPHANE, Quebec",
    "SAINT-ESPRIT, Quebec",
    "SAINT-ETIENNE-DE-BEAUHARNOIS, Quebec",
    "SAINT-ETIENNE-DE-BOLTON, Quebec",
    "SAINT-ETIENNE-DE-LAUZON, Quebec",
    "SAINT-ETIENNE-DES-GRES, Quebec",
    "SAINT-EUGENE-D'ARGENTENAY, Quebec",
    "SAINT-EUGENE-DE-GRANTHAM, Quebec",
    "SAINT-EUGENE-DE-GUIGUES, Quebec",
    "SAINT-EUSEBE, Quebec",
    ...
    "SAINT-FELIX-D'OTIS, Quebec",
    "SAINT-FELIX-DE-DALQUIER, Quebec",
    "SAINT-FELIX-DE-KINGSEY, Quebec",
    "SAINT-FELIX-DE-VALOIS, Quebec",
    "SAINT-FERDINAND, Quebec",
    "SAINT-FERREOL-LES-NEIGES, Quebec",
    "SAINT-FLAVIEN, Quebec",
    "SAINT-FORTUNAT, Quebec",
    "SAINT-FRANCOIS-D'ASSISE, Quebec",
    "SAINT-FRANCOIS-D'ORLEANS, Quebec",
    "SAINT-FRANCOIS-DE-MADAWASKA, New Brunswick",
    "SAINT-FRANCOIS-DE-SALES, Quebec",
    "SAINT-FRANCOIS-DU-LAC, Quebec",
    "SAINT-FRANCOIS-XAVIER-DE-VIGER, Quebec",
    ...
    "SAINT-GEORGES-DE-MALBAIE, Quebec",
    "SAINT-GEORGES-DE-WINDSOR, Quebec",
    "SAINT-GERARD-DES-LAURENTIDES, Quebec",
    ...
    "SAINT-GREGOIRE, New Brunswick",
    "SAINT-GUILLAUME, Quebec",
    "SAINT-GUY, Quebec",
    "SAINT-HENRI-DE-LEVIS, Quebec",
    "SAINT-HERMENEGILDE, Quebec",
    "SAINT-HILARION, Quebec",
    "SAINT-HIPPOLYTE, Quebec",
    "SAINT-HONORE-DE-CHICOUTIMI, Quebec",
    "SAINT-HONORE-DE-SHENLEY, Quebec",
    "SAINT-HONORE-DE-TEMISCOUATA, Quebec",
    "SAINT-HUBERT, Quebec",
    "SAINT-HUBERT-RIVIERE-DU-LOUP, Quebec",
    "SAINT-HUGUES, Quebec",
    "SAINT-HYACINTHE, Quebec",
    "SAINT-IGNACE, New Brunswick",
    "SAINT-IGNACE-DE-LOYOLA, Quebec",
    "SAINT-IGNACE-DE-STANBRIDGE, Quebec",
    "SAINT-IRENEE, New Brunswick",
    "SAINT-IRENEE, Quebec",
    "SAINT-ISIDORE, New Brunswick",
    "SAINT-ISIDORE, Quebec",
    "SAINT-ISIDORE-DE-CLIFTON, Quebec",
    "SAINT-ISIDORE-DE-LAPRAIRIE, Quebec",
    ...
    "SAINT-JOSEPH-DE-HAM-SUD, Quebec",
    "SAINT-JOSEPH-DE-KAMOURASKA, Quebec",
    "SAINT-JOSEPH-DE-KENT, New Brunswick",
    ...
    "SAINT-JULES, Quebec",
    "SAINT-JULIEN, Quebec",
    "SAINT-JUST-DE-BRETENIERES, Quebec",
    "SAINT-JUSTE-DU-LAC, Quebec",
    "SAINT-JUSTIN, Quebec",
    "SAINT-LAMBERT, Quebec",
    "SAINT-LAMBERT-DE-LAUZON, Quebec",
    "SAINT-LAURENT NORD, New Brunswick",
    "SAINT-LAURENT, New Brunswick",
    "SAINT-LAURENT, Quebec",
    "SAINT-LAURENT-ILE-D'ORLEANS, Quebec",
    "SAINT-LAZARE, Quebec",
    "SAINT-LAZARE-DE-BELLECHASSE, Quebec",
    "SAINT-LEANDRE, Quebec",
    "SAINT-LEOLIN, New Brunswick",
    "SAINT-LEON, Quebec",
    "SAINT-LEON-LE-GRAND, Quebec",
    "SAINT-LEONARD, New Brunswick",
    "SAINT-LEONARD, Quebec",
    "SAINT-LEONARD-D'ASTON, Quebec",
    "SAINT-LEONARD-DE-PORTNEUF, Quebec",
    "SAINT-LEONARD-PARENT, New Brunswick",
    ...
    "SAINT-MAJORIQUE, Quebec",
    "SAINT-MALACHIE, Quebec",
    "SAINT-MALO, Quebec",
    "SAINT-MARC-DE-FIGUERY, Quebec",
    "SAINT-MARC-DES-CARRIERES, Quebec",
    ...
    "SAINT-PIERRE-ILE-D'ORLEANS, Quebec",
    ...
    "SAINT-REDEMPTEUR, Quebec",
    "SAINT-REMI, Quebec",
    "SAINT-REMI-D'AMHERST, Quebec",
    "SAINT-REMI-DE-TINGWICK, Quebec",
    "SAINT-RENE, Quebec",
    "SAINT-RENE-DE-MATANE, Quebec",
    "SAINT-ROBERT, Quebec",
    ...
    "SAINT-SEBASTIEN-DE-FRONTENAC, Quebec",
    "SAINT-SEVERE, Quebec",
    "SAINT-SEVERIN-DE-BEAUCE, Quebec",
    "SAINT-SIMEON, Quebec",
    "SAINT-SIMEON-DE-BONAVENTURE, Quebec",
    "SAINT-SIMON, New Brunswick",
    "SAINT-SIMON-DE-BAGOT, Quebec",
    "SAINT-SIMON-DE-RIMOUSKI, Quebec",
    "SAINT-SIMON-LES-MINES, Quebec",
    "SAINT-STANISLAS, Quebec",
    "SAINT-STANISLAS-DE-CHAMPLAIN, Quebec",
    "SAINT-STANISLAS-DE-KOSTKA, Quebec",
    "SAINT-SULPICE, Quebec",
    "SAINT-SYLVERE, Quebec",
    "SAINT-SYLVESTRE, Quebec",
    "SAINT-TELESPHORE, Quebec",
    "SAINT-THARCISIUS, Quebec",
    "SAINT-THEODORE-D'ACTON, Quebec",
    ...
    "SAINT-VALERE, Quebec",
    "SAINT-VALERIEN-DE-RIMOUSKI, Quebec",
    "SAINT-VALLIER, Quebec",
    "SAINT-VIANNEY, Quebec",
    "SAINT-VICTOR, Quebec",
    "SAINT-VITAL-DE-CLERMONT, Quebec",
    "SAINT-WENCESLAS, Quebec",
    "SAINT-WILFRED, New Brunswick",
    "SAINT-ZACHARIE, Quebec",
    "SAINT-ZENON, Quebec",
    "SAINT-ZEPHIRIN-DE-COURVAL, Quebec",
    "SAINT-ZOTIQUE, Quebec",
    "SAINTE ROSE, New Brunswick",
    "SAINTE-ADELE, Quebec",
    "SAINTE-AGATHE-DE-LOTBINIERE, Quebec",
    "SAINTE-AGATHE-DES-MONTS, Quebec",
    "SAINTE-AGATHE-NORD, Quebec",
    "SAINTE-AGNES-DE-DUNDEE, Quebec",
    "SAINTE-ANGELE-DE-MERICI, Quebec",
    "SAINTE-ANGELE-DE-MONNOIR, Quebec",
    "SAINTE-ANGELE-DE-PREMONT, Quebec",
    "SAINTE-ANNE GLOUCESTER CO, New Brunswick",
    ...
    "SAINTE-CECILE, New Brunswick",
    "SAINTE-CECILE-DE-LEVRARD, Quebec",
    "SAINTE-CECILE-DE-MASHAM, Quebec",
    "SAINTE-CECILE-DE-MILTON, Quebec",
    "SAINTE-CECILE-DE-WHITTON, Quebec",
    ...
    "SAINTE-ELISABETH, Quebec",
    "SAINTE-ELISABETH-DE-PROULX, Quebec",
    "SAINTE-ELIZABETH-DE-WARWICK, Quebec",
    "SAINTE-EMELIE-DE-L'ENERGIE, Quebec",
    "SAINTE-EULALIE, Quebec",
    "SAINTE-EUPHEMIE, Quebec",
    "SAINTE-FAMILLE, Quebec",
    "SAINTE-FELICITE, Quebec",
    "SAINTE-FELICITE-DE-L'ISLET, Quebec",
    "SAINTE-FLAVIE, Quebec",
    "SAINTE-FLORENCE, Quebec",
    "SAINTE-FRANCOISE, Quebec",
    "SAINTE-FRANCOISE-DE-LOTBINIERE, Quebec",
    "SAINTE-GENEVIEVE, Quebec",
    "SAINTE-GENEVIEVE-DE-BATISCAN, Quebec",
    "SAINTE-GERMAINE-BOULE, Quebec",
    "SAINTE-GERTRUDE-MANNEVILLE, Quebec",
    "SAINTE-HEDWIDGE-DE-ROBERVAL, Quebec",
    "SAINTE-HELENE-DE-BAGOT, Quebec",
    "SAINTE-HELENE-DE-BREAKEYVILLE, Quebec",
    "SAINTE-HELENE-DE-CHESTER, Quebec",
    "SAINTE-HELENE-DE-KAMOURASKA, Quebec",
    "SAINTE-HENEDINE, Quebec",
    "SAINTE-JULIE, Quebec",
    ...
    "SAINTE-MARIE-SAINT-RAPHAEL, New Brunswick",
    ...
    "SAINTE-MONIQUE-LAC-SAINT-JEAN, Quebec",
    "SAINTE-PAULE, Quebec",
    "SAINTE-PERPETUE, Quebec",
    "SAINTE-PERPETUE-DE-L'ISLET, Quebec",
    "SAINTE-PETRONILLE, Quebec",
    "SAINTE-RITA, Quebec",
    "SAINTE-ROSE, Quebec",
    ...
    "SAINTE-SABINE-DE-BELLECHASSE, Quebec",
    "SAINTE-SERAPHINE, Quebec",
    "SAINTE-SOPHIE, Quebec",
    "SAINTE-SOPHIE-D'HALIFAX, Quebec",
    "SAINTE-SOPHIE-DE-LEVRARD, Quebec",
    "SAINTE-THECLE, Quebec",
    "SAINTE-THERESE SUD, New Brunswick",
    "SAINTE-THERESE, Quebec",
    "SAINTE-THERESE-DE-GASPE, Quebec",
    "SAINTE-THERESE-DE-LA-GATINEAU, Quebec",
    ...
    "SALLUIT, Quebec",
    "SALLYS COVE, Newfoundland and Labrador",
    "SALMO, British Columbia",
    "SALMON ARM, British Columbia",
    "SALMON BEACH, New Brunswick",
    "SALMON COVE BDV, Newfoundland and Labrador",
    "SALMON CREEK, New Brunswick",
    "SALMON RIVER ROAD, New Brunswick",
    ...
    "SCOTCH RIDGE, New Brunswick",
    "SCOTCH SETTLEMENT YORK CO, New Brunswick",
    ...
    "SEAFORTH, Ontario",
    "SEAGRAVE, Ontario",
    "SEAL COVE FB, Newfoundland and Labrador",
    "SEAL COVE WB, Newfoundland and Labrador",
    "SEARCHMONT, Ontario",
    ...
    "SHALLOWAY COVE, Newfoundland and Labrador",
    "SHAMATTAWA, Manitoba",
    "SHAMROCK, Saskatchewan",
    "SHANKLIN, New Brunswick",
    ...
    "SHAWVILLE, Quebec",
    "SHEA HEIGHTS, Newfoundland and Labrador",
    "SHEARSTOWN, Newfoundland and Labrador",
    ...
    "SHENACADIE, Nova Scotia",
    "SHENSTONE, New Brunswick",
    "SHEPODY ALBERT CO, New Brunswick",
    "SHEPODY KINGS CO, New Brunswick",
    ...
    "SHIP HARBOUR PB, Newfoundland and Labrador",
    "SHIPMAN, Saskatchewan",
    "SHIPPAGAN, New Brunswick",
    "SHIPSHAW, Quebec",
    "SHIRLEY, British Columbia",
    "SHOAL LAKE, Manitoba",
    "SHOE COVE, Newfoundland and Labrador",
    "SHORTDALE, Manitoba",
    ...
    "SMILEY, Saskatchewan",
    "SMITH CROSSING, New Brunswick",
    "SMITH, Alberta",
    "SMITH'S CORNER, New Brunswick",
    ...
    "SMITHTOWN, New Brunswick",
    "SMITHVILLE, Ontario",
    "SMOKY LAKE, Alberta",
    "SMOOTH ROCK FALLS, Ontario",
    "SNIDER MOUNTAIN, New Brunswick",
    "SNOOKS ARM, Newfoundland and Labrador",
    "SNOW LAKE, Manitoba",
    ...
    "SOPS ARM, Newfoundland and Labrador",
    "SOREL-TRACY, Quebec",
    ...
    "SOUTH BRANCH KENT CO, New Brunswick",
    "SOUTH BRANCH KINGS CO, New Brunswick",
    "SOUTH BRANCH, Newfoundland and Labrador",
    "SOUTH BROOK GB, Newfoundland and Labrador",
    "SOUTH BROOKFIELD, Nova Scotia",
    "SOUTH CANAAN, New Brunswick",
    "SOUTH DILDO, Newfoundland and Labrador",
    "SOUTH EAST BIGHT, Newfoundland and Labrador",
    ...
    "SOUTH OROMOCTO LAKE, New Brunswick",
    ...
    "SOUTHERN BAY, Newfoundland and Labrador",
    "SOUTHERN HARBOUR PB, Newfoundland and Labrador",
    "SOUTHEY, Saskatchewan",
    "SOUTHFIELD, New Brunswick",
    "SOUTHPORT, Manitoba",
    ...
    "SPRINGBROOK, Alberta",
    "SPRINGBROOK, Ontario",
    "SPRINGDALE, New Brunswick",
    "SPRINGDALE, Newfoundland and Labrador",
    "SPRINGFIELD KINGS CO, New Brunswick",
    "SPRINGFIELD YORK CO, New Brunswick",
    ...
    "ST ADOLPHE, Manitoba",
    "ST AGATHA, Ontario",
    "ST ALBANS, Newfoundland and Labrador",
    "ST ALBERT, Ontario",
    "ST ALMO, New Brunswick",
    "ST ALPHONSE, Manitoba",
    "ST AMBROISE, Manitoba",
    "ST ANDREWS CHANNEL, Nova Scotia",
    ...
    "ST ANNS, Ontario",
    "ST ANTHONY EAST, Newfoundland and Labrador",
    "ST BENEDICT, Saskatchewan",
    "ST BERNARDIN, Ontario",
    "ST BERNARDS-JACQUES FONTAINE, Newfoundland and Labrador",
    ...
    "ST CLEMENTS, Ontario",
    "ST COLUMBA, Nova Scotia",
    "ST CROIX, New Brunswick",
    "ST DAVID RIDGE, New Brunswick",
    "ST DAVIDS, Newfoundland and Labrador",
    "ST DAVIDS, Ontario",
    "ST DENIS, Saskatchewan",
    "ST EUGENE, Ontario",
    "ST EUSTACHE, Manitoba",
    "ST FINTANS, Newfoundland and Labrador",
    "ST FRANCOIS XAVIER, Manitoba",
    "ST GEORGE BRANT, Ontario",
    "ST GEORGE, New Brunswick",
    "ST GEORGES, Newfoundland and Labrador",
    ...
    "ST JOACHIM, Ontario",
    "ST JOSEPH, Manitoba",
    "ST JOSEPHS SAL, Newfoundland and Labrador",
    ...
    "ST MARKS, Manitoba",
    "ST MARTIN, Manitoba",
    "ST MARTINS NORTH, New Brunswick",
    "ST MARTINS, New Brunswick",
    "ST MARYS, Newfoundland and Labrador",
    "ST MARYS, Ontario",
    "ST MICHAEL, Alberta",
    "ST PAUL, Alberta",
    ...
    "ST VINCENT, Alberta",
    "ST VINCENTS, Newfoundland and Labrador",
    "ST WALBURG, Saskatchewan",
    "ST WILLIAMS, Ontario",
    "ST-ANTOINE NORD, New Brunswick",
    "ST-ATHANASE, Quebec",
    "ST-BARNABE-NORD, Quebec",
    "ST-FRANCOIS-DE-LA-RIVIERE-DU-S, Quebec",
    "ST-FRANCOIS-XAVIER-DE-BROMPTON, Quebec",
    "ST-GABRIEL-DE-KAMOURASKA, Quebec",
    "ST-HILAIRE, New Brunswick",
    "ST-JEAN-BAPTISTE, New Brunswick",
    "ST-JOACHIM-DE-MONTMORENCY, Quebec",
    "ST-JOSEPH-DE-LA-POINTE-DE-LEVY, Quebec",
    "ST-JOSEPH-DE-MADAWASKA, New Brunswick",
    "ST-JOSEPH-DU-MOINE, Nova Scotia",
    "ST-LOUIS, Prince Edward Island",
    "ST-MARCEL-DE-L'ISLET, Quebec",
    "ST-NAZAIRE-DU-LAC-ST-JEAN, Quebec",
    "ST-OCTAVE, Quebec",
    "ST-ONESIME, Quebec",
    "ST-PETERS BAY, Prince Edward Island",
    "ST-PIERRE-DE-LA-RIVIERE-DU-SUD, Quebec",
    "ST-VALERIEN, Quebec",
    "ST. ALBERT, Alberta",
    ...
    "STANSTEAD, Quebec",
    "STAPLES SETTLEMENT, New Brunswick",
    "STAPLES, Ontario",
    ...
    "STE-IRENE-DE-MATAPEDIA, Quebec",
    "STE-JEANNE-D'ARC-DE-MATANE, Quebec",
    "STE-MARGUERITE-DE-DORCHESTER, Quebec",
    "STE-MARGUERITE-DU-LAC-MASSON, Quebec",
    "STEAD, Manitoba",
    "STEELMAN, Saskatchewan",
    "STEEP ROCK, Manitoba",
    "STEEVES MOUNTAIN, New Brunswick",
    "STEEVES SETTLEMENT, New Brunswick",
    "STEINBACH, Manitoba",
    "STELLA, Ontario",
    ...
    "STUARTBURN, Manitoba",
    "STUKELY-SUD, Quebec",
    "STUMP LAKE, Saskatchewan",
    "STURGEON COUNTY, Alberta",
    "STURGEON FALLS, Ontario",
    "STURGEON LANDING, Saskatchewan",
    "STURGIS, Saskatchewan",
    "STYMIEST, New Brunswick",
    "SUCCESS, Saskatchewan",
    "SUDBURY, Ontario",
    "SUGAR CAMP, Nova Scotia",
    "SULTAN, Ontario",
    "SUMMER BEAVER, Ontario",
    "SUMMERBERRY, Saskatchewan",
    "SUMMERFIELD CARLETON CO, New Brunswick",
    "SUMMERFIELD KINGS CO, New Brunswick",
    ...
    "SUSSEX SOUTH, New Brunswick",
    "SUSSEX, New Brunswick",
    "SUTTON WEST, Ontario",
    "SUTTON, Quebec",
    "SWALWELL, Alberta",
    "SWAN CREEK, New Brunswick",
    "SWAN HILLS, Alberta",
    "SWAN LAKE, Manitoba",
    "SWAN RIVER, Manitoba",
    "SWANSEA POINT, British Columbia",
    "SWASTIKA, Ontario",
    ...
    "THOROLD, Ontario",
    "THORSBY, Alberta",
    "THREE BROOKS, New Brunswick",
    "THREE HILLS, Alberta",
    "THREE TREE CREEK, New Brunswick",
    "THUNDER BAY, Ontario",
    "THURSO, Quebec",
    "TICHBORNE, Ontario",
    ...
    "TIVERTON, Ontario",
    "TIZZARDS HARBOUR, Newfoundland and Labrador",
    ...
    "TOUROND, Manitoba",
    "TOURVILLE, Quebec",
    "TOUTES AIDES, Manitoba",
    "TOWER HILL, New Brunswick",
    "TOWER ROAD, Nova Scotia",
    "TOWNSEND, Ontario",
    "TRACADIE BEACH, New Brunswick",
    "TRACADIE-SHEILA, New Brunswick",
    "TRACEY MILLS, New Brunswick",
    "TRACY, New Brunswick",
    "TRACYVILLE, New Brunswick",
    ...
    "TRES-SAINT-REDEMPTEUR, Quebec",
    "TRIBUNE, Saskatchewan",
    "TRING-JONCTION, Quebec",
    "TRINITY BB, Newfoundland and Labrador",
    "TRINITY TB, Newfoundland and Labrador",
    ...
    "TWIN BUTTE, Alberta",
    "TWO BROOKS, New Brunswick",
    "TWO HILLS, Alberta",
    "TYNDALL, Manitoba",
    "TYNE VALLEY, Prince Edward Island",
    "TYNEMOUTH CREEK, New Brunswick",
    "TYNER, Saskatchewan",
    "TYVAN, Saskatchewan",
    ...
    "UPPER BRIGHTON, New Brunswick",
    "UPPER BROOKSIDE, Nova Scotia",
    "UPPER CANADA VILLAGE, Ontario",
    "UPPER CAPE, New Brunswick",
    "UPPER CAVERHILL, New Brunswick",
    ...
    "UPPER GOLDEN GROVE, New Brunswick",
    "UPPER GRAND MIRA, Nova Scotia",
    "UPPER HAINESVILLE, New Brunswick",
    ...
    "VILLAGE SAINT-PIERRE, Quebec",
    "VILLAGE-DES-POIRIER, New Brunswick",
    ...
    "WALFORD STATION, Ontario",
    "WALHACHIN, British Columbia",
    "WALKER SETTLEMENT, New Brunswick",
    "WALKERTON, Ontario",
    "WALLACE, Nova Scotia",
    "WALLACEBURG, Ontario",
    "WALLACETOWN, Ontario",
    ...
    "WARBURG, Alberta",
    "WARD SETTLEMENT, New Brunswick",
    "WARDEN, Quebec",
    "WARDLOW, Alberta",
    "WARDNER, British Columbia",
    "WARDS CREEK, New Brunswick",
    "WARDSVILLE, Ontario",
    "WARE, British Columbia",
    ...
    "WARSAW, Ontario",
    "WARSPITE, Alberta",
    "WARWICK SETTLEMENT, New Brunswick",
    "WARWICK, Quebec",
    ...
    "WATERVILLE CARLETON CO, New Brunswick",
    "WATERVILLE, Nova Scotia",
    "WATERVILLE, Quebec",
    "WATERVILLE-SUNBURY, New Brunswick",
    "WATFORD, Ontario",
    "WATINO, Alberta",
    ...
    "WEST FLORENCEVILLE, New Brunswick",
    "WEST GUILFORD, Ontario",
    "WEST INDIAN ROAD, Nova Scotia",
    ...
    "WEST QUACO, New Brunswick",
    "WEST RIVER STATION, Nova Scotia",
    "WEST RIVER, New Brunswick",
    ...
    "WHYNOTTS SETTLEMENT, Nova Scotia",
    "WIARTON, Ontario",
    "WICKHAM, New Brunswick",
    "WICKHAM, Quebec",
    "WICKLOW, New Brunswick",
    "WIDEWATER, Alberta",
    "WIGGINS MILL, New Brunswick",
    "WIKWEMIKONG, Ontario",
    "WILBERFORCE, Ontario",
    "WILCOX, Saskatchewan",
    "WILD COVE WB, Newfoundland and Labrador",
    "WILDWOOD, Alberta",
    ...
    "WILLIAMSTOWN CARLETON CO, New Brunswick",
    ...
    "WINGHAM, Ontario",
    "WINGS POINT, Newfoundland and Labrador",
    "WINKLER, Manitoba",
    ...
    "WOODBRIDGE, Ontario",
    "WOODFORDS, Newfoundland and Labrador",
    "WOODHAM, Ontario",
    "WOODLANDS, Manitoba",
    ...
    "ZEPHYR, Ontario",
    "ZHODA, Manitoba",
    "ZIONVILLE, New Brunswick",
    "ZURICH, Ontario"
  ];

  let ontarioCities=cities.filter(city=>city.includes("Ontario"));
  module.exports=ontarioCities;